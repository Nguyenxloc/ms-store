                                            ...
                                            <div class="modal fade" id="staticBackdrop1${i.id}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="/admin/quan-ly-mau-sac/update/${i.id}" method="post" id="capNhatForm${i.id}" onsubmit="return validateForm(${i.id})">
                                                                <div class="mb-3">
...
<script>
    ...
    function validateForm(id) {
        ...
        if (nameInput === "") {
            ...
            // Kiểm tra tên không được trùng nếu không có lỗi khác
            if (!hasError) {
                for (var i = 0; i < listMS.length; i++) {
                    if (listMS[i].ten.toLowerCase() === nameInput.toLowerCase()) {
                        nameError.textContent = "Tên màu sắc đã tồn tại.";
                        hasError = true;
                        break;
                    }
                }
