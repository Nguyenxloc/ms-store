            ...
            <table class="table table-bordered text-center mb-0">
                ...
                <c:forEach items="${listHDCT}" varStatus="hoaDonChiTietDTO" var="hdct">
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-danger"><fmt:formatNumber value="${hdct.donGia * hdct.soLuong}"
                                                                               type="currency" currencyCode="VND"/></td>
                        <td class="align-middle">
                            <button onclick="confirmDelete(${hdct.spct.id})" class="button_remove btn btn-sm btn-primary"><i class="fa fa-times"></i></button>
                        </td>
                    </tr>
    ...
    function confirmDelete(productId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Toast.fire({
                    icon: "success",
                    title: "Xóa sản phảm khỏi giỏ hàng thành công"
                });
                window.location.href = 'http://localhost:8080/cart/remove-from-cart/' + productId;
