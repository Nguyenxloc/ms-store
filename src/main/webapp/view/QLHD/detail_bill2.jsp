        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form id="confirmForm" method="post" action="/hoa-don2/xac-nhan/${hoaDonDTO.id}">
                ...
                <div class="modal fade" id="undoModal" tabindex="-1" aria-labelledby="undoModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form id="undoForm" method="post" action="/hoa-don2/hoan-tac/${hoaDonDTO.id}">
                                <div class="modal-header">
                ...
                <div class="modal fade" id="cancelModal" tabindex="-1" aria-labelledby="cancelModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form id="cancelForm" method="post" action="/hoa-don2/huy/${hoaDonDTO.id}">
                                <div class="modal-header">
                ...
                <div class="modal fade" id="paymentModal" tabindex="-1" aria-labelledby="paymentModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/hoa-don2/xac-nhan-thanh-toan" method="post">
                        ...
                        <div class="card w-100 h-100">
                            ...
                            <fmt:formatNumber value="${tongTien}" type="currency" currencySymbol="₫"
                                        ...
                                        <p class="fw-bold mb-1 pb-3 small d-flex justify-content-between">
                                            ...
                                            <span class="fw-normal " data-phiship="${giaoHangDTO.phiShip}">
                                                <fmt:formatNumber value="${giaoHangDTO.phiShip}" type="currency" currencySymbol="₫"
                                                                  groupingUsed="true"/>
                            ...
                            <form method="post" action="/hoa-don2/cap-nhat/${hoaDonDTO.id}"
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="tenTT${hoaDonDTO.id}" name="tenTT"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="tenQH${hoaDonDTO.id}" name="tenQH"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="tenPX${hoaDonDTO.id}" name="tenPX" title="Chọn phường xã">
                                            <!-- Options populated dynamically -->
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" hidden value="${giaoHangDTO.phiShip}" name="phiShip">
                        ...
                        <div class="mb-3 p-3" style="background-color: #f0f0f0;">
                            ...
                            <!-- Các select -->
                            <%-- Lọc theo thuộc tính                             --%>
                            <form method="post" action="/hoa-don2/filter">
                                <div class="row mt-3">
                                    <div class="col-md-3">
...
<script>
    ...
    function openPrintDeliveryModal() {
        ...
        iframe.src = '/hoa-don2/in-phieu-giao-hang';
    ...
    $(document).ready(function () {
        ...
        $('form[id^="suaDiaChi"]').submit(function (e) {
            ...
            // var serviceUrl = 'https://online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/available-services?shop_id=1244&to_district=' + idQuan + '&from_district=3440';
            var serviceUrl = 'https://online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/available-services?shop_id=1244&from_district=3440&to_district='+idQuan;
            getJSONWithToken(serviceUrl, function (data_maDV) {
        ...
        $('.delete-product').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'GET',
                        url: '/hoa-don2/xoa-san-pham/' + idCTSP,
                        data: {
                            idHoaDon: idHoaDon
                        },
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.update-sl').click(function () {
            ...
            $.ajax({
                type: 'GET',
                url: '/hoa-don2/cap-nhat-so-luong-san-pham/' + idCTSP,
                data: {
                    idHoaDon: idHoaDon,
                    soLuong: newQuantity
                },
...
<script>
    ...
    $(document).ready(function () {
        $('#colorSelect').on('change', function () {
            ...
            $.ajax({
                url: "/hoa-don2/locSPCTByMauSac/" + productId,
                type: 'GET',
                data: {id: productId},
    ...
    $(document).ready(function () {
        $('#sizeSelect').on('change', function () {
            ...
            alert(productId);
            $.ajax({
                url: "/hoa-don2/locSPCTByKichThuoc/" + productId,
                type: 'GET',
                data: {id: productId},
                success: function (data) {
                    $('#contentModalAddProduct').empty()
    ...
    $(document).ready(function () {
        $('#materialSelect').on('change', function () {
            var productId = $(this).val();
            $.ajax({
                url: "/hoa-don2/locSPCTByChatLieu/" + productId,
                type: 'GET',
                data: {id: productId},
                success: function (data) {
                    $('#contentModalAddProduct').empty()
    ...
    $(document).ready(function () {
        $('#sleeveSelect').on('change', function () {
            var productId = $(this).val();
            $.ajax({
                url: "/hoa-don2/locSPCTByKieuTay/${hoaDon.id}/" + productId,
                type: 'GET',
                data: {id: productId},
                success: function (data) {
                    $('#contentModalAddProduct').empty()
    ...
    function bindEvents() {
        $('#colorSelect').on('change', function () {
            ...
            updateModalContent("/hoa-don2/locSPCTByMauSac/" + colorId);
        });
