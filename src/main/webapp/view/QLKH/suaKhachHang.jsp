        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <sf:form id="khachHangForm" method="post" action="/admin/quan-ly-khach-hang/sua-khach-hang/${khachHang.id}" enctype="multipart/form-data"
                                ...
                                <div class="card" style="height: 550px">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center" style="margin-top: 40px">
                                            ...
                                            <a href="/admin/quan-ly-khach-hang/hien-thi">
