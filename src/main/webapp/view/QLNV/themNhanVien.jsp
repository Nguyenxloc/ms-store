        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <sf:form id="nhanVienForm" method="post" action="/admin/quan-ly-nhan-vien/them-nhan-vien" enctype="multipart/form-data"
                                ...
                                <div class="card" style="height: 550px">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center" style="margin-top: 40px">
                                            ...
                                            <a href="/admin/quan-ly-nhan-vien/hien-thi">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <sf:form method="post" action="/admin/quan-ly-nhan-vien/them-chuc-vu" id="chucVuForm" modelAttribute="chucVu">
                        <div class="row">
                            <div class="col-7">
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <c:forEach varStatus="i" items="${listChucVuAll}" var="chucVu">
                                <form id="suaCVForm${chucVu.id}" method="post" action="/admin/quan-ly-nhan-vien/sua-chuc-vu/${chucVu.id}">
                                    <tr>
                                        <th>${i.index+1}</th>
                                        <td>
